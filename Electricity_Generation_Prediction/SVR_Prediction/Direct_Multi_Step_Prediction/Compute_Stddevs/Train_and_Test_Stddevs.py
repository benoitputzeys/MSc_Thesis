...
pred_test = pd.read_csv('Electricity_Generation_Prediction\SVR_Prediction\Direct_Multi_Step_Prediction\Pred_Test.csv', delimiter=',')
pred_train = pd.read_csv('Electricity_Generation_Prediction\SVR_Prediction\Direct_Multi_Step_Prediction\Pred_Train.csv', delimiter=',')
...
axs3.set_ylabel("SVR error during training, GW", size = 14)
...
axs4.set_ylabel("SVR error during training, GW", size = 14)
...
axs6.scatter(error_test["SP"],
             ...
             alpha=0.05, label = "Projected Errors", color = "red")
axs6.set_ylabel("SVR error during test set, GW", size = 14)
...
axs7.fill_between(test_stats.iloc[:,0],
                  ...
                  (test_stats.iloc[:,1]+test_stats.iloc[:,2]),
                  alpha=0.2, color = "orange", label = "+- 1x Standard Deviation")
axs7.set_ylabel("SVR error during test set, GW", size = 14)
...
fig7.show()
fig7.savefig("Electricity_Generation_Prediction/SVR_Prediction/Figures/DMST_Mean_and_Stddev_of_Error_Test_Set_Pred.pdf", bbox_inches='tight')

########################################################################################################################
# Save the results in a csv file.
########################################################################################################################

training_stats.to_csv("Compare_Models/Direct_Multi_Step_Probability_Results/Probability_Based_on_Training/SVR_mean_errors_stddevs_train.csv")
test_stats.to_csv("Compare_Models/Direct_Multi_Step_Probability_Results/Probability_Based_on_Training/SVR_mean_errors_stddevs_test.csv")
