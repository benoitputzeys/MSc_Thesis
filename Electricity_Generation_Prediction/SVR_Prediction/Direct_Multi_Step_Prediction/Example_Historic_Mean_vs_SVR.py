...
SVR_pred = pd.read_csv('Electricity_Generation_Prediction/SVR_Prediction/Direct_Multi_Step_Prediction/Pred_Test.csv')
...
fig1.show()
fig1.savefig("Electricity_Generation_Prediction/SVR_Prediction/Figures/DMST_Prediction_Compared_to_Historic_Variability.pdf", bbox_inches='tight')
...
axs2.grid(True)
fig2.show()
fig2.savefig("Electricity_Generation_Prediction/SVR_Prediction/Figures/Actual_Values_Compared_to_Historic_Variability.pdf", bbox_inches='tight')
