...
print("-"*200)
error_test = (result_future - y_test[:48*7*2])
print("The mean absolute error of the prediction is %0.2f" % mean_absolute_error(y_test[:48*7*2],result_future[-48*7*2:]))
print("The mean squared error of the prediction is %0.2f" % mean_squared_error(y_test[:48*7*2],result_future[-48*7*2:]))
print("The root mean squared error of prediction set is %0.2f" % np.sqrt(mean_squared_error(y_test[:48*7*2],result_future[-48*7*2:])))
print("-"*200)
...
error_test_plot = np.zeros((48*3+48*7*2,1))
error_test_plot[-336*2:] = error_test[:48*7*2]
...
axs2[0].plot(dates.iloc[-len(X_test):-len(X_test)+48*7*2],
             result_future[:48*7*2,0],
...
axs2[1].grid(True)
axs2[1].plot(dates.iloc[-len(X_test)-48*3:-len(X_test)+48*7*2],
             error_test_plot,
