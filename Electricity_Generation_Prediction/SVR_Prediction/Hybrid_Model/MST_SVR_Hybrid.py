...
pd.DataFrame(result_train_2).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_train2_other_metrics/SVR_prediction.csv")
pd.DataFrame(result_test).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_test_other_metrics/SVR_prediction.csv")
