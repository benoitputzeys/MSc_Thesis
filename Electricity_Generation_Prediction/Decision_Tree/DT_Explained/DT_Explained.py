...
axs1.legend()
fig1.show()
fig1.savefig("Electricity_Generation_Prediction/Decision_Tree/Figures/Decision_Tree_Explained.pdf", bbox_inches='tight')
...
graph.write_pdf('Electricity_Generation_Prediction/Decision_Tree/Figures/Tree_Decisions.pdf')
