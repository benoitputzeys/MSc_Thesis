...
df_pred_test.to_csv("Electricity_Generation_Prediction/Random_Forest/Direct_Multi_Step_Prediction/Pred_Test.csv")
df_pred_train.to_csv("Electricity_Generation_Prediction/Random_Forest/Direct_Multi_Step_Prediction/Pred_Train.csv")
