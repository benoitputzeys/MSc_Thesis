...
regressor = pickle.load(open("Electricity_Generation_Prediction/Random_Forest/my_model.sav", 'rb'))
...
axes2[0].plot(y_values_dates, linewidth=0.5, label ="Prediction 7 days in the future with RF")
...
pd.DataFrame(result_future).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_train2_other_metrics/RF_prediction.csv")
