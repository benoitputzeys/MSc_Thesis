...
#
#my_model.save("Electricity_Generation_Prediction/ANN/Direct_Multi_Step_Prediction/DMST_ANN_Prediction.h5")
#
## Plot the loss per epoch.
#metric = "mean_absolute_error"
#plot_the_loss_curve(np.linspace(1,len(hist_list), len(hist_list) ), hist_list[metric])

my_model = keras.models.load_model("Electricity_Generation_Prediction/ANN/Direct_Multi_Step_Prediction/DMST_ANN_Prediction.h5")
...
df_pred_test.to_csv("Electricity_Generation_Prediction/ANN/Direct_Multi_Step_Prediction/Pred_Test.csv")
df_pred_train.to_csv("Electricity_Generation_Prediction/ANN/Direct_Multi_Step_Prediction/Pred_Train.csv")
