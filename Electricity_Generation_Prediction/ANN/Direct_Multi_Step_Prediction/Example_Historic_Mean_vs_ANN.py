...
ANN_pred = pd.read_csv('Electricity_Generation_Prediction/ANN/Direct_Multi_Step_Prediction/Pred_Test.csv')
...
fig1.show()
fig1.savefig("Electricity_Generation_Prediction/ANN/Figures/DMST_Prediction_Compared_to_Historic_Variability.pdf", bbox_inches='tight')
...
axs2.grid(True)
fig2.show()
fig2.savefig("Electricity_Generation_Prediction/ANN/Figures/Actual_Values_Compared_to_Historic_Variability.pdf", bbox_inches='tight')
