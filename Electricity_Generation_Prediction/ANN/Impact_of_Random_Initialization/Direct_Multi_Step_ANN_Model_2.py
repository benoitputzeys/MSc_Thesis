...
#my_model = keras.models.load_model("Electricity_Generation_Prediction/ANN/Direct_Multi_Step_Prediction/Model_2.h5")
...
df_errors.to_csv("Electricity_Generation_Prediction/ANN/Impact_of_Random_Initialization/Results/NN_error_Model_2.csv")
