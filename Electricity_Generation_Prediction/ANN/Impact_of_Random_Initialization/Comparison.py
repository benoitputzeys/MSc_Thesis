...
Model_1 = pd.read_csv("Electricity_Generation_Prediction/ANN/Impact_of_Random_Initialization/Results/NN_error_Model_1.csv")
Model_2 = pd.read_csv("Electricity_Generation_Prediction/ANN/Impact_of_Random_Initialization/Results/NN_error_Model_2.csv")
...
fig2.show()
fig2.savefig("Electricity_Generation_Prediction/ANN/Figures/Random_Initialization.pdf", bbox_inches='tight')
