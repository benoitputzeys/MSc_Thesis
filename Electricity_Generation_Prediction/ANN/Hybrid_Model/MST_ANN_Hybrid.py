...
my_model.save("Electricity_Generation_Prediction/Hybrid/Hybrid_ANN.h5")
##my_model = keras.models.load_model("Electricity_Generation_Prediction/Hybrid/Hybrid_ANN.h5")
...
pd.DataFrame(result_train_2).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_train2_other_metrics/ANN_prediction.csv")
pd.DataFrame(result_test).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_test_other_metrics/ANN_prediction.csv")
