...
my_model = keras.models.load_model("Electricity_Generation_Prediction/ANN/Recursive_Prediction/SST_No_Trans_No_Date_No_SP.h5")
...
fig2.show()
fig2.savefig("Electricity_Generation_Prediction/ANN/Figures/Recursive_Prediction_No_SP.pdf", bbox_inches='tight')
