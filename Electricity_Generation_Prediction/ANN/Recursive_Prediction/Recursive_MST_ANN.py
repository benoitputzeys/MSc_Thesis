...
my_model = keras.models.load_model("Electricity_Generation_Prediction/ANN/Recursive_Prediction/SST_No_Trans_No_Date.h5")
...
axs2[0].plot(dates.iloc[-len(X_test):-len(X_test)+48*7],result_future[:48*7,0]/1000, label = "LSTM Prediction", color = "orange")
