...
my_model.save("Electricity_Generation_Prediction/ANN/Feature_Analysis/DMST_ANN_model_No_Transmission.h5")
#my_model = keras.models.load_model("Electricity_Generation_Prediction/ANN/Reature_Analysis/DMST_ANN_model_No_Transmission.h5")
