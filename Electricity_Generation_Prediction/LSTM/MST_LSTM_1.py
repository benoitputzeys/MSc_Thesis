...
from Electricity_Generation_Prediction.ANN.Functions_ANN import create_dates
...
my_model = keras.models.load_model("Electricity_Generation_Prediction/LSTM/my_model.h5")
