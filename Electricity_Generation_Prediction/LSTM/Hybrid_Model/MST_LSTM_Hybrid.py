...
from Electricity_Generation_Prediction.LSTM.Functions_LSTM import plot_the_loss_curve, train_model, create_model
...
pd.DataFrame(result_train_2).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_train2_other_metrics/LSTM_prediction.csv")
pd.DataFrame(result_test).to_csv("Electricity_Generation_Prediction/Hybrid_Model/Pred_test_other_metrics/LSTM_prediction.csv")
