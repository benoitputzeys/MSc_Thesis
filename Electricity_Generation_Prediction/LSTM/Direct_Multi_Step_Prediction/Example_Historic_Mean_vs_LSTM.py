...
axs1[0].plot(dates[-15619:-15282], series[-15619:-15282], color = "black", label = "1 Week in Test Set\n(Actual Load)")
...
axs1[1].plot(dates[-15619:-15282],
             ...
             label = "Error \n(Prediction - Actual Values)", alpha = 1, color = "red")
...
axs2.plot(dates[-15619:-15282], series[-15619:-15282], color = "black", label = "1 Week in Test Set")
