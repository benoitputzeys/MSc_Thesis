...
df_features["Load_Past"] = df["Load"].shift(+48)
df_features["Transmission_Past"] = df["Transmission"].shift(+48)
...
X.to_csv("Data_Preprocessing/For_48_SP_Step_Prediction/X.csv")
y.to_csv("Data_Preprocessing/For_48_SP_Step_Prediction/y.csv")
