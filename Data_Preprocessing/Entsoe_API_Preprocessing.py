...
axs7[0].axes.tick_params(labelsize = 11)
axs7[0].grid(True)
...
axs10.plot(load_GB_processed/1000)
axs10.set_ylabel("Load in GB [GW]", size = 18)
...
axs21[0].set_ylabel("Difference Raw Data [GW]", size = 12)
axs21[1].plot((shifted_processed-not_shifted_processed)/1000)
axs21[1].set_ylabel("Difference Processed Data [GW]", size = 12)
