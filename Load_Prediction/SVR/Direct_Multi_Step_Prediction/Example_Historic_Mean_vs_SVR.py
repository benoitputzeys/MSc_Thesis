...
fig1.show()
fig1.savefig("Load_Prediction/SVR/Figures/DMST_Prediction_Compared_to_Historic_Variability.pdf", bbox_inches='tight')
...
axs2.grid(True)
fig2.show()
fig2.savefig("Load_Prediction/SVR/Figures/Actual_Values_Compared_to_Historic_Variability.pdf", bbox_inches='tight')
