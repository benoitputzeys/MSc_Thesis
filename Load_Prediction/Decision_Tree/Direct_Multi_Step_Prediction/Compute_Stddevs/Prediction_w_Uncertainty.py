...
pred_train = pd.read_csv('Load_Prediction/Decision_Tree/Direct_Multi_Step_Prediction/Pred_Train.csv', delimiter=',')
...
fig4.show()
fig4.savefig("Load_Prediction/Decision_Tree/Figures/DMSP_Mean_and_Stddev_of_Error_Train_Set_Pred.pdf", bbox_inches='tight')
...
plt.xticks(np.arange(1,482, 48), ["14:00\n07/22","14:00\n07/23","14:00\n07/24",
                                  ...
                                  "14:00\n07/31","14:00\n08/01"])
fig5.show()
fig5.savefig("Load_Prediction/Decision_Tree/Figures/DMSP_Pred_w_Uncertainty.pdf", bbox_inches='tight')
...
fig7.show()
# Save the figure
fig7.savefig("Load_Prediction/Decision_Tree/Figures/DMSP_Mean_and_Stddev_of_Error_Test_Set_Pred.pdf", bbox_inches='tight')
