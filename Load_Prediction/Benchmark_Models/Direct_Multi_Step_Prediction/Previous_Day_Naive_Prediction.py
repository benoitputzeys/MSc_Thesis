...
X = pd.read_csv('Data_Preprocessing/For_48_SP_Step_Prediction/X.csv', delimiter=',')
X = X.set_index("Time")
dates = X.iloc[:,-1]
X = X.iloc[:,:-1]

y = pd.read_csv('Data_Preprocessing/For_48_SP_Step_Prediction/y.csv', delimiter=',')
y = y.set_index("Time")
...
df_errors.to_csv("Compare_Models/Single_Step_Results/Naive_Previous_Day.csv")
