...
pd.DataFrame(result_train_2).to_csv("Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/RF_prediction.csv")
pd.DataFrame(result_test).to_csv("Load_Prediction/Hybrid_Model/Pred_test_other_metrics/RF_prediction.csv")
