...
########################################################################################################################
# Inverse the scaling. Divide by 1000 to express ever<thing in GW.
########################################################################################################################
...
# Include additional details such as tick intervals, rotation, legend positioning, grid on and saving the figure.
...
fig2.show()
fig2.savefig("Load_Prediction/Random_Forest/Figures/Iterative_Prediction_no_SP.pdf", bbox_inches='tight')

########################################################################################################################
# Results for iterative prediction are not saved because in general they yield poor results.
########################################################################################################################
