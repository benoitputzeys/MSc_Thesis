...
my_model = keras.models.load_model("Load_Prediction/LSTM/Iterative_Prediction/SST_No_Trans_No_Date.h5")
...
fig2.show()
fig2.savefig("Load_Prediction/LSTM/Figures/Iterative_Prediction.pdf", bbox_inches='tight')
