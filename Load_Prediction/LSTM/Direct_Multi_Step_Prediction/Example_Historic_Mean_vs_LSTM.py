...
########################################################################################################################
# Calculate the mean per week and subtract that value from the actual load. Project on a single week.
########################################################################################################################
...
########################################################################################################################
# Plot with the historic mean and variability of the data and include the 7-day ahead prediction of the LSTM
########################################################################################################################

# Load the LSTM prediction so that it can be compared to the template above.
LSTM_pred = pd.read_csv('Load_Prediction/LSTM/Direct_Multi_Step_Prediction/Pred_Test.csv')
LSTM_pred = LSTM_pred.iloc[:,-1]

# Plot the variability from the training set in blue with the values from the test set in black and the LSTM
