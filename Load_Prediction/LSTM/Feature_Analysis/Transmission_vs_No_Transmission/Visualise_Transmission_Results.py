...
F6_No_Transmission = pd.read_csv("Load_Prediction/LSTM/Feature_Analysis/Transmission_vs_No_Transmission/F6_(No_Transmission).csv")
...
fig3.show()
fig3.savefig("Load_Prediction/LSTM/Figures/Histograms_Transmission_vs_No_Transmission.pdf", bbox_inches='tight')
