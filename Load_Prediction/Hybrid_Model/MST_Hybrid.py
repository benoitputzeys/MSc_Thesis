...
from Load_Prediction.Hybrid_Model.Functions import create_model, train_model, plot_the_loss_curve
import pandas as pd
...
ANN_train = genfromtxt('Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/ANN_prediction.csv', delimiter=',')
RF_train = genfromtxt('Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/RF_prediction.csv', delimiter=',')
DT_train = genfromtxt('Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/DT_prediction.csv', delimiter=',')
SVR_train = genfromtxt('Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/SVR_prediction.csv', delimiter=',')
LSTM_train = genfromtxt('Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/LSTM_prediction.csv', delimiter=',')
SARIMA_train = genfromtxt('Load_Prediction/Hybrid_Model/Pred_train2_other_metrics/SARIMA_prediction.csv', delimiter=',')

ANN_test = genfromtxt('Load_Prediction/Hybrid_Model/Pred_test_other_metrics/ANN_prediction.csv', delimiter=',')
RF_test = genfromtxt('Load_Prediction/Hybrid_Model/Pred_test_other_metrics/RF_prediction.csv', delimiter=',')
DT_test = genfromtxt('Load_Prediction/Hybrid_Model/Pred_test_other_metrics/DT_prediction.csv', delimiter=',')
SVR_test = genfromtxt('Load_Prediction/Hybrid_Model/Pred_test_other_metrics/SVR_prediction.csv', delimiter=',')
LSTM_test = genfromtxt('Load_Prediction/Hybrid_Model/Pred_test_other_metrics/LSTM_prediction.csv', delimiter=',')
SARIMA_test = genfromtxt('Load_Prediction/Hybrid_Model/Pred_test_other_metrics/SARIMA_prediction.csv', delimiter=',')
...
my_model.save("Load_Prediction/Hybrid_Model/Hybrid_ANN.h5")

#my_model = keras.models.load_model("Load_Prediction/Hybrid_Model/Hybrid_ANN.h5")
