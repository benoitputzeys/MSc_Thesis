...
# Partition the data into 80% training and 20% test set.
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.2, random_state = 0, shuffle = False)

# Divide the data into half the length according to the findings in the thesis.
...
########################################################################################################################
# Import the predictions from the ANN.
########################################################################################################################

pred_test = pd.read_csv('Load_Prediction/ANN/Direct_Multi_Step_Prediction/Pred_Test.csv', delimiter=',')
pred_train = pd.read_csv('Load_Prediction/ANN/Direct_Multi_Step_Prediction/Pred_Train.csv', delimiter=',')
...
# Create a data frame that contains the SPs (1-336) and the load values.
...
fig4.show()
# Save the figure.
fig4.savefig("Load_Prediction/ANN/Figures/DMSP_Mean_and_Stddev_of_Error_Train_Set_Pred.pdf", bbox_inches='tight')
...
fig5.show()
# Save the figure.
fig5.savefig("Load_Prediction/ANN/Figures/DMSP_Pred_w_Uncertainty.pdf", bbox_inches='tight')
...
# Plot the projected errors onto a single week to see the variation in the timeseries of the test set.
...
fig7.show()
# Save the figure.
fig7.savefig("Load_Prediction/ANN/Figures/DMSP_Mean_and_Stddev_of_Error_Test_Set_Pred.pdf", bbox_inches='tight')
