...
fig4.show()
# Save the figure.
fig4.savefig("Load_Prediction/ANN/Figures/DMST_Mean_and_Stddev_of_Error_Train_Set_Pred.pdf", bbox_inches='tight')
...
fig5.show()
# Save the figure.
fig5.savefig("Load_Prediction/ANN/Figures/DMST_Pred_w_Uncertainty.pdf", bbox_inches='tight')
...
fig7.show()
# Save the figure.
fig7.savefig("Load_Prediction/ANN/Figures/DMST_Mean_and_Stddev_of_Error_Test_Set_Pred.pdf", bbox_inches='tight')
