...
my_model.save("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMST_ANN_35L_Training_Set.h5")
...
import csv
with open('Load_Prediction\ANN\Training_Set_Size_Analysis\AF_35L.csv', 'w', newline='',) as file:
