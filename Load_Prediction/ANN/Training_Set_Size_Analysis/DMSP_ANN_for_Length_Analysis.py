...
#fig.show()
#
#my_model.save("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_34L_Training_Set.h5")

########################################################################################################################
# Load one of the models from the directory "Models".
########################################################################################################################

my_model = keras.models.load_model("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_1L_Training_Set.h5")
#my_model = keras.models.load_model("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_12L_Training_Set.h5")
#my_model = keras.models.load_model("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_14L_Training_Set.h5")
#my_model = keras.models.load_model("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_25L_Training_Set.h5")
#my_model = keras.models.load_model("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_34L_Training_Set.h5")
#my_model = keras.models.load_model("Load_Prediction/ANN/Training_Set_Size_Analysis/Models/DMSP_ANN_35L_Training_Set.h5")
