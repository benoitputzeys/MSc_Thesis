...
axes2[0].bar(['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'],df_training_errors.iloc[:,0], color='blue')
axes2[0].set_ylabel('MSE, GW^2', size = 14)
axes2[0].set_xticklabels(rotation=90, labels = ['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'])
axes2[0].grid(True)

axes2[1].bar(['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'],df_training_errors.iloc[:,1], color='blue')
axes2[1].set_ylabel('MAE, GW', size = 14)
axes2[1].set_xticklabels(rotation=90, labels = ['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'])
axes2[1].grid(True)

axes2[2].bar(['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'],df_training_errors.iloc[:,2], color='blue')
axes2[2].set_ylabel('RMSE, GW', size = 14)
axes2[2].grid(True)
axes2[2].set_xticklabels(rotation=90, labels = ['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'])
...
axes3[0].bar(['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'],df_test_errors.iloc[:,0], color='blue')
axes3[0].set_ylabel('MSE, GW^2', size = 14)
axes3[0].set_xticklabels(rotation=90, labels = ['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'])
axes3[0].grid(True)

axes3[1].bar(['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'], df_test_errors.iloc[:,1], color='blue')
axes3[1].set_ylabel('MAE, GW', size = 14)
axes3[1].set_xticklabels(rotation=90, labels = ['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'])
axes3[1].grid(True)

axes3[2].bar(['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'],df_test_errors.iloc[:,2], color='blue')
axes3[2].set_ylabel('RMSE, GW', size = 14)
axes3[2].grid(True)
axes3[2].set_xticklabels(rotation=90, labels = ['Naive','NN_Rd_Weights','DT','NN','RF','SVR','LSTM'])
fig3.subplots_adjust(top = 0.25, wspace = 150)
fig3.show()
...
mean_error_NN = NN_mean_stddev_training.iloc[:,0] - NN_mean_stddev_training.iloc[:,2]
stddev_NN = NN_mean_stddev_training.iloc[:,1]
...
axes4[0].plot(x_axis, NN_mean_stddev_training.iloc[:,-2], color='orange')
axes4[0].fill_between(x_axis,
                   (NN_mean_stddev_training.iloc[:,-2]+NN_mean_stddev_training.iloc[:,-1]),
                   (NN_mean_stddev_training.iloc[:,-2]-NN_mean_stddev_training.iloc[:,-1]),
                   alpha = 0.2, color='orange')
axes4[0].set_ylim([-5.4,5.4])
axes4[1].plot(x_axis, LSTM_mean_stddev_training.iloc[:,-2], color='orange')
axes4[1].fill_between(x_axis,
                   (LSTM_mean_stddev_training.iloc[:,-2]+LSTM_mean_stddev_training.iloc[:,-1]),
                   (LSTM_mean_stddev_training.iloc[:,-2]-LSTM_mean_stddev_training.iloc[:,-1]),
                   alpha = 0.2, color='orange')
axes4[1].set_ylim([-5.4,5.4])
axes4[2].plot(x_axis, RF_mean_stddev_training.iloc[:,-2], color='orange')
axes4[2].fill_between(x_axis,
                   (RF_mean_stddev_training.iloc[:,-2]+RF_mean_stddev_training.iloc[:,-1]),
                   (RF_mean_stddev_training.iloc[:,-2]-RF_mean_stddev_training.iloc[:,-1]),
                   alpha = 0.2, color='orange')
axes4[2].set_ylim([-5.4,5.4])
axes4[3].plot(x_axis, SVR_mean_stddev_training.iloc[:,-2], color='orange')
axes4[3].fill_between(x_axis,
                   (SVR_mean_stddev_training.iloc[:,-2]+SVR_mean_stddev_training.iloc[:,-1]),
                   (SVR_mean_stddev_training.iloc[:,-2]-SVR_mean_stddev_training.iloc[:,-1]),
                   alpha = 0.2, color='orange')
...
fig4.show()
fig4.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/Training_Set/All_Stddevs_of_Errors_Train.pdf", bbox_inches='tight')
...
fig5.show()
fig5.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/Training_Set/NN_Stddev_of_Error_Train.pdf", bbox_inches='tight')
...
fig6.show()
fig6.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/Training_Set/LSTM_Stddev_of_Error_Train.pdf", bbox_inches='tight')

########################################################################################################################
# Compare the mean and standard deviations of errors of the DT between predictions and true values of the training set.
########################################################################################################################
...
fig77.show()
fig77.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/Training_Set/DT_Stddev_of_Error_Train.pdf", bbox_inches='tight')
...
fig7.show()
fig7.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/Training_Set/RF_Stddev_of_Error_Train.pdf", bbox_inches='tight')
...
fig8.show()
fig8.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/Training_Set/SVR_Stddev_of_Error_Train.pdf", bbox_inches='tight')

########################################################################################################################
# Compare the mean and standard deviations of errors of the NN with Random Weigths between predictions and true values of the training set.
########################################################################################################################
