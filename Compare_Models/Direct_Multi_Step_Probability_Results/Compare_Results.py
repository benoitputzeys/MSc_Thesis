...
axes2[0].set_xticklabels(rotation=0, labels = ['DT','Naive','NN','LSTM','RF','SVR'])
axes2[0].grid(True)

axes2[1].bar(['DT','Naive','NN','LSTM','RF','SVR'],df_training_errors.iloc[:,1], color='blue')
axes2[1].set_ylabel('MAE [GW]', size = 14)
axes2[1].set_xticklabels(rotation=0, labels = ['DT','Naive','NN','LSTM','RF','SVR'])
axes2[1].grid(True)

axes2[2].bar(['DT','Naive','NN','LSTM','RF','SVR'],df_training_errors.iloc[:,1], color='blue')
axes2[2].set_ylabel('RMSE [GW]', size = 14)
axes2[2].grid(True)
axes2[2].set_xticklabels(rotation=0, labels = ['DT','Naive','NN','LSTM','RF','SVR'])
...
axes3[0].set_xticklabels(rotation=0, labels = ['DT','Naive','NN','LSTM','RF','SVR'])
axes3[0].grid(True)

axes3[1].bar(['DT','Naive','NN','LSTM','RF','SVR'], df_test_errors.iloc[:,1], color='blue')
axes3[1].set_ylabel('MAE [GW]', size = 14)
axes3[1].set_xticklabels(rotation=0, labels = ['DT','Naive','NN','LSTM','RF','SVR'])
axes3[1].grid(True)

axes3[2].bar(['DT','Naive','NN','LSTM','RF','SVR'],df_test_errors.iloc[:,1], color='blue')
axes3[2].set_ylabel('RMSE [GW]', size = 14)
axes3[2].grid(True)
axes3[2].set_xticklabels(rotation=0, labels = ['DT','Naive','NN','LSTM','RF','SVR'])
...
fig5.show()
fig5.savefig("Compare_Models/Direct_Multi_Step_Probability_Results/Figures/NN_Stddev_of_Error_Train.pdf", bbox_inches='tight')
