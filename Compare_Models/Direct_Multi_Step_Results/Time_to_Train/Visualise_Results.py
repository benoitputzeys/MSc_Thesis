...
ANN = pd.read_csv("Compare_Models/Direct_Multi_Step_Results/Time_to_Train/ANN.csv")
NN_Rd_Weights = pd.read_csv("Compare_Models/Direct_Multi_Step_Results/Time_to_Train/NN_Rd_Weights.csv")
DT = pd.read_csv("Compare_Models/Direct_Multi_Step_Results/Time_to_Train/DT.csv")
LSTM = pd.read_csv("Compare_Models/Direct_Multi_Step_Results/Time_to_Train/LSTM.csv")
Random_Forest = pd.read_csv("Compare_Models/Direct_Multi_Step_Results/Time_to_Train/RF.csv")
SVR = pd.read_csv("Compare_Models/Direct_Multi_Step_Results/Time_to_Train/SVR.csv")
