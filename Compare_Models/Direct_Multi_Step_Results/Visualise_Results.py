...
axes2[0].bar(['DT', 'Naive', 'ANN','LSTM','RF','SVR'], df.iloc[:,1], color='blue')
axes2[0].set_ylabel('MSE, GW^2', size = 14)
axes2[0].set_xticklabels(rotation=0, labels = string)
axes2[0].grid(True)

axes2[1].bar(['DT', 'Naive', 'ANN','LSTM','RF','SVR'], df.iloc[:,2], color='blue')
axes2[1].set_ylabel('MAE, GW', size = 14)
axes2[1].set_xticklabels(rotation=0, labels = string)
axes2[1].grid(True)

axes2[2].bar(['DT', 'Naive', 'ANN','LSTM','RF','SVR'], df.iloc[:,3], color='blue')
...
axes3[0].bar(['DT', 'Naive', 'ANN','LSTM','RF','SVR'], df.iloc[:,4], color='blue')
axes3[0].set_ylabel('MSE, GW^2', size = 14)
axes3[0].set_xticklabels(rotation=0, labels = string)
axes3[0].grid(True)

axes3[1].bar(['DT', 'Naive', 'ANN','LSTM','RF','SVR'], df.iloc[:,5], color='blue')
axes3[1].set_ylabel('MAE, GW', size = 14)
axes3[1].set_xticklabels(rotation=0, labels = string)
axes3[1].grid(True)

axes3[2].bar(['DT', 'Naive', 'ANN','LSTM','RF','SVR'], df.iloc[:,6], color='blue')
