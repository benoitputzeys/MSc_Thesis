...
pd.DataFrame(result_train_2).to_csv(
    "/Users/benoitputzeys/PycharmProjects/MSc_Thesis/Electricity_generation/Hybrid_Model/Pred_train2_other_metrics/LSTM_prediction.csv")
pd.DataFrame(result_test).to_csv(
    "/Users/benoitputzeys/PycharmProjects/MSc_Thesis/Electricity_generation/Hybrid_Model/Pred_test_other_metrics/LSTM_prediction.csv")

import csv
with open('/Users/benoitputzeys/PycharmProjects/MSc_Thesis/Compare_Models/MST2_results/LSTM_result.csv', 'w', newline='',) as file:
