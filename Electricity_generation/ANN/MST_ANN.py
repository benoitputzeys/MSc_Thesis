...
for k in range(0,len(y_test)/(48*7)):
...
pd.DataFrame(result_future).to_csv("/Users/benoitputzeys/PycharmProjects/MSc_Thesis/Electricity_generation/Hybrid_Model/ANN_prediction.csv")
