...
from Electricity_generation.ANN.Functions_ANN import plot_the_loss_curve, train_model, previousday, nested_sum, create_model
...
plot_the_loss_curve(np.linspace(1,len(epochs_list), len(epochs_list) ), loss_list)
...
with open('/Users/benoitputzeys/PycharmProjects/NN-Predicitons/Compare_Models/ANN_result.csv', 'w', newline='',) as file:
    ...
    writer.writerow(["ANN", str(np.mean(error_NN_test*error_NN_test))])